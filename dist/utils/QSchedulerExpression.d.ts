...
export declare function EVERY_FIRST_DAY_OF_MOUNTH_AT(time: Time): string;
export declare function EVERY_DAY_AT(time: Time): string;
export declare function EVERY_WEEK_AT(time: Time): string;
//# sourceMappingURL=QSchedulerExpression.d.ts.map