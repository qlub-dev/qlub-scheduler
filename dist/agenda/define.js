...
const define = function (name, options, processor) {
    ...
    this._definitions[name] = {
        fn: processor,
        concurrency: (options === null || options === void 0 ? void 0 : options.concurrency) || this._defaultConcurrency,
        lockLimit: (options === null || options === void 0 ? void 0 : options.lockLimit) || this._defaultLockLimit,
        priority: (options === null || options === void 0 ? void 0 : options.priority) || JobPriority.normal,
        lockLifetime: (options === null || options === void 0 ? void 0 : options.lockLifetime) || this._defaultLockLifetime,
        running: 0,
        locked: 0,
        shouldSaveResult: (options === null || options === void 0 ? void 0 : options.shouldSaveResult) || false,
        logging: (options === null || options === void 0 ? void 0 : options.logging) != null
            ? options.logging
            : true,
    };
